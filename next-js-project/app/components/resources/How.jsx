...
import Icon1 from '../../icons/resources/how/icon1.svg'
import Icon2 from '../../icons/resources/how/icon2.svg'
        ...
        <div className='pt-1 px-20 max-sm:px-4 pb-24'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 w-full">
                {[
                    ...
                    >
                        <Image className="w-16 h-16 object-contain shrink-0 mt-1" src={icon} alt="" />
