import Imagee from '../../icons/resources/learn/image.svg';
import Icon1 from '../../icons/resources/learn/gettingStarted/icon1.svg';
import Icon2 from '../../icons/resources/learn/gettingStarted/icon2.svg';
import Icon3 from '../../icons/resources/learn/gettingStarted/icon3.svg';
        ...
        <div className="pt-1 px-5 md:px-20 pb-24">
            ...
            <div className="border border-[#EFEFEF] rounded-xl px-5 py-5 md:px-7 flex max-lg:flex-col justify-between items-start md:items-center gap-6 mb-24">
                ...
                <div className="w-full md:w-auto flex justify-center">
                    <Image src={Imagee} alt="Map Explorer" className="w-full max-w-full md:max-w-sm lg:max-w-md"  loading='lazy'/>
                </div>
            </div>
            <div className='pt-1'>
