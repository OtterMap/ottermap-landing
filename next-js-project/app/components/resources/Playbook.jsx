...
import Image1 from '../../icons/resources/playbook/playbook1.svg';
import Image2 from '../../icons/resources/playbook/playbook2.svg';
import Image3 from '../../icons/resources/playbook/playbook3.svg';
import Image4 from '../../icons/resources/playbook/playbook4.svg';
            ...
            <div className='flex flex-col lg:flex-row justify-between gap-5'>
                {usecases.map((caseItem, index) => (
                    <div key={index} className='flex flex-col rounded-xl w-full lg:w-[30%] bg-white shadow-md'>
                        <Image className='rounded-t-xl w-full h-auto' src={caseItem.img} alt={caseItem.title} />
