import Advantage from '../../icons/whyus/advantages/advantage.png';
import Advantage1 from '../../icons/whyus/advantages/advantage1.svg';
import Advantage2 from '../../icons/whyus/advantages/advantage2.svg';
import Advantage3 from '../../icons/whyus/advantages/advantage3.svg';
import Advantage4 from '../../icons/whyus/advantages/advantage4.svg';
                ...
                <div className='xl:w-[50%] sm:grid sm:grid-cols-2 gap-8 flex flex-col'>
                    {
                        advantages.map((advantage, index) => (
                            <div key={index} className='flex gap-4 justify-start items-start'>
                                <div className='w-8 h-8 shrink-0 object-cover'><Image src={advantage.icon} alt="" /></div>
