...
import Icon1 from '../../icons/whyus/guesswork/icon1.svg';
import Icon2 from '../../icons/whyus/guesswork/icon2.svg';
import Icon3 from '../../icons/whyus/guesswork/icon3.svg';
import Icon4 from '../../icons/whyus/guesswork/icon4.svg';
        ...
        <div className='px-20 max-sm:px-1 pb-24'>
            <div className='flex flex-col gap-6 justify-center items-center pb-20'>
                ...
                <div className='flex flex-row gap-4 text-sm max-sm:text-xs font-medium'>
                    <button
                        ...
                        className="text-white cursor-pointer bg-[#218448] border-2 rounded-full px-7 py-3 max-sm:py-2 flex items-center justify-center gap-2 text-nowrap hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                        Try for free
                    ...
                    <button
                        ...
                        className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-7 py-3 max-sm:py-2 text-nowrap hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                        Book a demo
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 max-sm:grid-cols-2 gap-6 w-full max-sm:px-2">
                {[
                    ...
                    >
                        <Image className="w-12 h-12 object-contain shrink-0" src={icon} alt="" />
