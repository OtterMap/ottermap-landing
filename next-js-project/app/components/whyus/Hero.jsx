import Banner from '../../icons/whyus/hero/banner.png';
import RightArrow from '../../icons/rightArrow.svg';
import Icon1 from '../../icons/whyus/hero/successMetrics/icon1.svg';
import Icon2 from '../../icons/whyus/hero/successMetrics/icon2.svg';
import Icon3 from '../../icons/whyus/hero/successMetrics/icon3.svg';
            ...
            <div className='pt-20'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6 w-full">
                    {[
                        ...
                        >
                            <Image className="w-13 h-13 object-contain shrink-0" src={icon} alt="" />
