...
import Banner from '../../icons/about/hero/banner.svg';
import Mission from '../../icons/about/hero/mission.svg';
        ...
        <div className='px-20 max-sm:px-6 pb-24'>
                ...
                <div className="absolute top-25 max-sm:top-14  left-4 sm:left-10 lg:left-20 rounded-3xl text-white lg:pr-28 py-6 flex flex-col gap-5 w-[90%] sm:w-[80%] md:w-[60%] xl:w-[60%] 2xl:w-[50%]">
                    ...
                    <div className='flex gap-4 justify-start items-center'>
                        <button
                            ...
                            className="bg-[#218448] cursor-pointer rounded-full text-white px-7 py-3 max-sm:py-1.5 text-sm max-sm:text-[10px] flex items-center gap-2 mt-4 hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                        ...
                        <button
                            ...
                            className="border-2 cursor-pointer border-[#218448] bg-white rounded-full text-black px-7 py-3 max-sm:py-1.5 text-sm max-sm:text-[10px] flex items-center gap-2 mt-4 hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                            Book a Demo
                        </button>
                    </div>
                </div>
            ...
            <div className='flex justify-between items-center max-lg:flex-col gap-10 max-lg:gap-10'>
                ...
                <div className='xl:w-[40%] h-[504px] max-sm:h-[310px]'>
                    <Image className='h-full object-contain' src={Mission} alt="" />
                </div>
