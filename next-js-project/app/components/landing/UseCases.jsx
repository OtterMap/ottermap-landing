...
import UseCase1 from '../../icons/landing/useCases/useCase1.png';
import UseCase2 from '../../icons/landing/useCases/useCase2.png';
import UseCase3 from '../../icons/landing/useCases/useCase3.png';
import UseCase4 from '../../icons/landing/useCases/useCase4.png';
            ...
            <div className='flex flex-col lg:flex-row justify-between gap-5'>
                {usecases.map((caseItem, index) => (
                    <div key={index} className='flex flex-col rounded-2xl w-full lg:w-[30%] max-sm:w-full bg-white shadow-md'>
                        <Image className='rounded-t-xl w-full h-[210px] max-sm:h-[142px] object-cover' src={caseItem.img} alt={caseItem.title} height='auto' width='auto' />
