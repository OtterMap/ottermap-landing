...
import ProblemSolution1 from '../../icons/landing/problemSolution/problemSolution1.svg';
import ProblemSolution2 from '../../icons/landing/problemSolution/problemSolution2.svg';
import ProblemSolution3 from '../../icons/landing/problemSolution/problemSolution3.svg';
import ProblemSolution4 from '../../icons/landing/problemSolution/problemSolution4.svg';
import Image1 from '../../icons/landing/problemSolution/image1.png';
import Image2 from '../../icons/landing/problemSolution/image2.png';
import Image3 from '../../icons/landing/problemSolution/image3.png';
import Image4 from '../../icons/landing/problemSolution/image4.png';
    ...
    return (
        <div className="flex flex-col px-4 sm:px-8 lg:px-20 xl:px-20 pt-28 md:pt-28 pb-8 gap-10">
            ...
            <div className="pt-20 max-sm:pt-0 px-4 md:px-2 container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-20 max-sm:gap-6">
                {/* Image Section */}
                <div className="w-full lg:w-1/2 max-lg:w-full flex justify-start">
                    <Image
                        ...
                        >
                            <div className="flex flex-col gap-2 text-base sm:text-lg max-sm:text-xs font-semibold text-[#de0000]">
                                <div className="flex gap-3 items-center uppercase font-bold">
                                    <Image className="w-6 h-6 sm:w-7 sm:h-7 object-contain" src={item.icon} alt="Problem icon" />
                                    <span>{item.chip}</span>
                                </div>
