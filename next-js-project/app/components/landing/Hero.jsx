...
import HeroImage1 from '../../icons/landing/heroImages/heroImage1.png';
import HeroImage2 from '../../icons/landing/heroImages/heroImage2.png';
import HeroImage3 from '../../icons/landing/heroImages/heroImage3.png';
...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-evenly items-start w-full pt-10 lg:pt-20 px-5 lg:px-10 gap-10 bg-white">
      ...
      <div className="lg:w-[45.5%] max-lg:w-full px-2 sm:px-5 lg:px-0">
        <Image
