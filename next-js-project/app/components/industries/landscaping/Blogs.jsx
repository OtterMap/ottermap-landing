...
import Blog1 from '../../../icons/industries/landscaping/blog/blog1.svg';
import BlogPerson1 from '../../../icons/industries/landscaping/blog/blogPerson1.jpg';
const Blogs = () => {
    const blogs = [
        {
            id: 1,
                    ...
                    <div key={blog.id} className="flex justify-center gap-8 w-1/3 pt-28 pb-2">
                        <div className='bg-[#f4f5fb] rounded-xl w-[90%] flex flex-col gap-8 pb-14 mt-2'>
                            ...
                            <div className='flex justify-center mt-6 mx-6'>
                                <Image src={blog.image} alt="" loading='lazy' />
                            </div>
                            <div className='flex flex-col gap-5'>
                                ...
                                <div className='flex gap-3 pl-6 items-center'>
                                    <div>
                                        <Image className='w-8 h-8 rounded-full' src={blog.person} alt="" />
                                    </div>
                                    <div>
