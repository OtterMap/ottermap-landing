...
import Icon1 from '../../../icons/industries/snow/challenges/challengeIcon1.svg';
import Icon2 from '../../../icons/industries/snow/challenges/challengeIcon2.svg';
import Icon3 from '../../../icons/industries/snow/challenges/challengeIcon3.svg';
import Icon4 from '../../../icons/industries/snow/challenges/challengeIcon4.svg';
const Challenges = () => {
    const challenges = [
            {
                id: 1,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
                {
                    challenges.map((challenge, index) => (
                        ...
                        >
                            <Image src={challenge.icon} alt="" className="h-13 w-13 max-sm:h-13 max-sm:w-13" />
