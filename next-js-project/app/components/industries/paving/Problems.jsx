...
import Icon1 from '../../../icons/industries/paving/problems/icon1.svg';
import Icon2 from '../../../icons/industries/paving/problems/icon2.svg';
import Icon3 from '../../../icons/industries/paving/problems/icon3.svg';
import Icon4 from '../../../icons/industries/paving/problems/icon4.svg';
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='flex flex-col md:flex-row gap-5'>
                    <div className='w-full md:w-7/12 bg-[#04471E]/10 rounded-2xl p-6 md:pl-14 md:py-16 flex flex-col gap-6'>
                        <Image className='w-14 h-14 max-sm:w-10 max-sm:h-10 object-contain' src={Icon1} alt="" />
                    ...
                    <div className='w-full md:w-5/12 bg-[#04471E]/10 rounded-2xl p-6 md:pl-14 md:py-16 flex flex-col gap-6'>
                        <Image className='w-14 h-14 max-sm:w-10 max-sm:h-10 object-contain' src={Icon2} alt="" />
                        <div className='flex flex-col gap-3 text-black'>
                ...
                <div className='flex flex-col md:flex-row gap-5'>
                    <div className='w-full md:w-5/12 bg-[#04471E]/10 rounded-2xl p-6 md:pl-14 md:py-16 flex flex-col gap-6'>
                        <Image className='w-14 h-14 max-sm:w-10 max-sm:h-10 object-contain' src={Icon3} alt="" />
                        <div className='flex flex-col gap-3 text-black'>
                    ...
                    <div className='w-full md:w-7/12 bg-[#04471E]/10 rounded-2xl p-6 md:pl-14 md:py-16 flex flex-col gap-6'>
                        <Image className='w-14 h-14 max-sm:w-10 max-sm:h-10 object-contain' src={Icon4} alt="" />
                        <div className='flex flex-col gap-3 text-black'>
