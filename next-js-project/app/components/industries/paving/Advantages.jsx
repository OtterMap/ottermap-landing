...
import Advantage from '../../../icons/industries/paving/advantages/advantage.png';
import Advantage1 from '../../../icons/industries/paving/advantages/advantage1.svg';
import Advantage2 from '../../../icons/industries/paving/advantages/advantage2.svg';
import Advantage3 from '../../../icons/industries/paving/advantages/advantage3.svg';
import Advantage4 from '../../../icons/industries/paving/advantages/advantage4.svg';
                ...
                <div className='xl:w-[50%] grid grid-cols-2 max-sm:grid-cols-1 gap-10'>
                    {
                        advantages.map((advantage, index) => (
                            <div key={index} className='flex gap-4 max-sm:gap-1 justify-start items-start'>
                                <div className='w-10'><Image src={advantage.icon} alt="" /></div>
                    ...
                    <div className='flex flex-row gap-4 text-sm max-sm:text-xs font-medium'>
                        <button
                            ...
                            className="text-white cursor-pointer bg-[#218448] border-2 rounded-full px-6 py-3 max-sm:py-2 flex items-center justify-center gap-2 text-nowrap hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                            Try for free
                        ...
                        <button
                            ...
                            className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-6 py-3 max-sm:py-2 text-nowrap hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                            Book a demo
                        </button>
                    </div>
                </div>
                <div className='xl:w-[50%] flex justify-center'>
                    <Image src={Advantage} alt="" loading='lazy' />
                </div>
            </div>
