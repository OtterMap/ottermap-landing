...
import Icon1 from '../../../icons/industries/facilitiesServices/solutions/icon1.svg';
import Icon2 from '../../../icons/industries/facilitiesServices/solutions/icon2.svg';
import Icon3 from '../../../icons/industries/facilitiesServices/solutions/icon3.svg';
import Icon4 from '../../../icons/industries/facilitiesServices/solutions/icon4.svg';
import Icon5 from '../../../icons/industries/facilitiesServices/solutions/icon5.svg';
import Icon6 from '../../../icons/industries/facilitiesServices/solutions/icon6.svg';
import { customTrack } from '../../../utils/mixpanel/customTrack';
import Imagee from '../../../icons/industries/facilitiesServices/solutions/image.png';
            ...
            <div className="flex flex-col items-center max-w-screen-xl mx-auto">
                ...
                <div className="flex flex-row flex-wrap justify-center gap-4 text-sm max-sm:text-xs font-medium pb-20">
                    <button
                        ...
                        className="text-white cursor-pointer bg-[#218448] border-2 rounded-full px-6 py-3 max-sm:py-2 max-sm:px-4 flex items-center justify-center gap-2 hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                        Try for free
                    ...
                    <button
                        ...
                        className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-7 py-3 max-sm:py-2 max-sm:px-4 hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                        Book a demo
                    </button>
                </div>

                <div className="w-full rounded-2xl bg-[#D7F4E499] mb-12">
                    <Image src={Imagee} alt="" loading='lazy' />
                </div>
                ...
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 w-full">
                    {[
                        ...
                        <div key={i} className="flex flex-col gap-5 items-start py-8 px-6 border-[0.5px] border-[#218448] rounded-lg">
                            <Image className="w-6 h-6 object-contain shrink-0" src={icon} alt="" />
