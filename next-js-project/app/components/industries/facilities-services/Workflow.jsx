...
import Icon1 from '../../../icons/industries/facilitiesServices/workflows/icon1.svg';
import Icon2 from '../../../icons/industries/facilitiesServices/workflows/icon2.svg';
import Icon3 from '../../../icons/industries/facilitiesServices/workflows/icon3.svg';
import Icon4 from '../../../icons/industries/facilitiesServices/workflows/icon4.svg';
        ...
        <div className='pb-20 pt-1 px-4 sm:px-8 md:px-16 lg:px-20'>
                ...
                <div className='flex flex-col gap-4 max-w-2xl'>
                    ...
                    <div className='flex flex-row flex-wrap gap-4 text-sm max-sm:text-xs font-medium pt-2'>
                        ...
                        <button
                            ...
                            className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-6 py-3 max-sm:py-2 max-sm:px-4 hover:shadow-2xl hover:scale-105 hover:transform hover:transition-all hover:duration-200 hover:ease-in-out">
                            Book a demo
                        </button>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                {[
                    ...
                    >
                        <Image className="w-6 h-6 object-contain shrink-0 mt-1" src={icon} alt="" />
