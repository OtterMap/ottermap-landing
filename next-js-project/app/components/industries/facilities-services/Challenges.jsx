...
import Icon1 from '../../../icons/industries/facilitiesServices/challenges/challengeIcon1.svg';
import Icon2 from '../../../icons/industries/facilitiesServices/challenges/challengeIcon2.svg';
import Icon3 from '../../../icons/industries/facilitiesServices/challenges/challengeIcon3.svg';
import Icon4 from '../../../icons/industries/facilitiesServices/challenges/challengeIcon4.svg';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
                {
                    challenges.map((challenge, index) => (
                        ...
                        >
                            <Image src={challenge.icon} alt="" className="h-13 w-13" />
