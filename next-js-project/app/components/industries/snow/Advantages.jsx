...
import Advantage from '../../../icons/industries/snow/advantages/advantage.png';
import Advantage1 from '../../../icons/industries/snow/advantages/advantage1.svg';
import Advantage2 from '../../../icons/industries/snow/advantages/advantage2.svg';
import Advantage3 from '../../../icons/industries/snow/advantages/advantage3.svg';
import Advantage4 from '../../../icons/industries/snow/advantages/advantage4.svg';
                ...
                <div className='xl:w-[50%] grid grid-cols-2 max-sm:grid-cols-1 gap-10'>
                    {
                        advantages.map((advantage, index) => (
                            <div key={index} className='flex gap-4 max-sm:gap-2 justify-start items-start'>
                                <div className='w-20'><Image src={advantage.icon} alt="" /></div>
