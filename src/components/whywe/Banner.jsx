                ...
                <div className="absolute bottom-8 sm:bottom-12 lg:bottom-14 left-4 sm:left-10 lg:left-14 bg-[#ffffff] rounded-3xl text-[#218448] px-5 sm:px-7 lg:pl-7 lg:pr-28 py-6 flex flex-col gap-6 w-[90%] sm:w-[80%] max-sm:w-[73%] md:w-fit opacity-90">
                    ...
                    <div className='flex flex-row gap-4 text-sm max-sm:text-[8px] font-medium'>
                        <button
                            ...
                            className="text-white cursor-pointer bg-[#218448] border-2 rounded-full px-7 py-3 max-sm:py-1 max-sm:px-3 flex items-center justify-center gap-2 text-nowrap">
                            Try for free
                        ...
                        <button
                            ...
                            className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-7 py-3 max-sm:py-1 max-sm:px-3 text-nowrap">
                            Book a demo
                        </button>
                    </div>
                </div>
