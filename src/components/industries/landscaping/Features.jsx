import Feature1 from '../../../assets/industries/landscaping/features/feature1.svg';
import RightArrow from '../../../assets/rightArrow.svg';
import FeatureIcon1 from '../../../assets/industries/landscaping/features/icon1.svg';
import FeatureIcon2 from '../../../assets/industries/landscaping/features/icon2.svg';
import FeatureIcon3 from '../../../assets/industries/landscaping/features/icon3.svg';
import FeatureIcon4 from '../../../assets/industries/landscaping/features/icon4.svg';
                    ...
                    <div className='w-full lg:w-1/2 flex flex-col justify-center items-start max-sm:pl-4 gap-8'>
                        <div className='flex gap-8 max-sm:gap-6 flex-col'>
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                <div className='flex gap-4 sm:gap-6'>
                                    <img src={FeatureIcon4} alt="" className="w-14 h-14 max-sm:w-13 max-sm:h-13" />
                                    <div className='flex flex-col gap-1'>
                                        <div className='text-lg sm:text-xl max-sm:text-base font-medium'>
