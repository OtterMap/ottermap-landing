                ...
                <div className='flex flex-col gap-4 max-w-xl'>
                    ...
                    <div className='flex flex-row flex-wrap gap-4 text-sm max-sm:text-xs font-medium pt-2'>
                        <button
                            ...
                            className="text-white cursor-pointer bg-[#218448] border-2 rounded-full px-7 py-3 max-sm:py-2 flex items-center justify-center gap-2">
                            Try for free
                        ...
                        <button
                            ...
                            className="text-black cursor-pointer border-2 border-[#218448] rounded-full px-7 py-3 max-sm:py-2">
                            Book a demo
                        </button>
                    </div>
                </div>
